...
"""
function writeEvalContributionsSectors(filename::String, evalContributions::Array{Float64,2})
...
"""
function writeEvalContributions(filename::String, evalContributions::Array{Float64,2})
